...
if __name__ == "__main__":
    dynamic_array = SingleLinkedList[Cat]()
    dynamic_array.push_head(Cat("Max", 4))
    dynamic_array.push_head(Cat("Tom", 4))
    dynamic_array.push_tail(Cat("Katya", 4))
    dynamic_array.insert(2, Cat("Lexa", 4))
    print(f"List size: {dynamic_array.get_size()}")

    def print_list(data : T) :
        print(data)

    dynamic_array.for_each(print_list)
